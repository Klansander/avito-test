...
1. Для авторизации доступов используются 2 вида токенов: пользовательский и админский.
2. Получение баннера происходит с помощью пользовательского или админского токена, а все остальные действия могут выполняться только с помощью админского токена.  
...
5. Добавлена возможность хранить версии баннера с возможностью выбора версии
6. Добавлен метод удаления баннеров по фиче или тегу
7. Описана конфигурация линтера
